...
const Hero = () => {
  ...
  const handleGetQuote = () => {
    toast({
      title: "🚧 Portfolio Quote Coming Soon!",
      description: "Portfolio quote system isn't implemented yet—but don't worry! You can request it in your next prompt! 🚀"
    });
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="font-display font-bold text-4xl md:text-6xl leading-tight text-shadow">
              Professional <span className="gradient-text">Portfolio Creation</span>
            </h1>
            
            <p className="text-xl text-gray-300 leading-relaxed">
              Showcase your work with elegance and impact. We create dynamic, interactive 
              portfolios that tell your story, highlight your expertise, and attract the 
              right opportunities.
            </p>
