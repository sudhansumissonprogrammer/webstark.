...
const Hero = () => {
  ...
  const handleGetQuote = () => {
    toast({
      ...
      description: "Quote functionality isn't implemented yet—but don't worry! You can request it in your next prompt! 🚀"
    });
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Transform your business with bespoke, high-performance websites that captivate 
              your audience and drive exceptional results. Built with cutting-edge technology 
              and tailored to your unique brand identity.
            </p>
          ...
          >
            <div className="glass-effect rounded-2xl p-8 floating-animation">
              <img 
                ...
                alt="Custom website development showcase"
